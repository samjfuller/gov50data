#' Local TV news data
#'
#' Data on content and slant of local TV news in 2017
#'
#' @source Martin and McCrain (2019).
#' 
"news"
...
#'
#' Data from 528 on state-level polling for Joe Biden and Donald Trump
...
#'
#' Election results from the 2020 US presidential election at the
#' state level
#'
#' 
